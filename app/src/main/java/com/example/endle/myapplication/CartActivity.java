...
public class CartActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int swipeDir) {
                ...
                Uri uri = MedicineContract.MedicineEntry.CONTENT_URI_CART;
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        String[] projection = {
                MedicineContract.MedicineEntry._CARTID,
                MedicineContract.MedicineEntry.COLUMN_CART_NAME,
                MedicineContract.MedicineEntry.COLUMN_CART_IMAGE,
                MedicineContract.MedicineEntry.COLUMN_CART_QUANTITY,
                MedicineContract.MedicineEntry.COLUMN_CART_TOTAL_PRICE,
        };

        // This loader will execute the ContentProvider's query method on a background thread
        return new CursorLoader(this,   // Parent activity context
                MedicineContract.MedicineEntry.CONTENT_URI_CART,   // Provider content URI to query
    ...
    public double calculateTotal(Cursor cursor){
        ...
        {
            int price = cursor.getColumnIndex(MedicineContract.MedicineEntry.COLUMN_CART_TOTAL_PRICE);
    ...
    public void paymentClick(View pressed) {
        ...
        PayPalPayment payment = new PayPalPayment(new BigDecimal(totalPrice), "SGD", "Being payment for items ordered" ,
