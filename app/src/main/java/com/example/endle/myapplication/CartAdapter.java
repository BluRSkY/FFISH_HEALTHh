...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.CartViewHolder> {
    ...
    public void onBindViewHolder(CartViewHolder holder, int position) {
        ...
        int idIndex = mCursor.getColumnIndex(MedicineContract.MedicineEntry._CARTID);
        int fragranceName = mCursor.getColumnIndex(MedicineContract.MedicineEntry.COLUMN_CART_NAME);
        int image = mCursor.getColumnIndex(MedicineContract.MedicineEntry.COLUMN_CART_IMAGE);
        int quantity = mCursor.getColumnIndex(MedicineContract.MedicineEntry.COLUMN_CART_QUANTITY);
        int price = mCursor.getColumnIndex(MedicineContract.MedicineEntry.COLUMN_CART_TOTAL_PRICE);
