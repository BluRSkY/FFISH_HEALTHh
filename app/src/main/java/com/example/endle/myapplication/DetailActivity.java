...
import com.example.endle.myapplication.data.MedicineProvider;
import com.example.endle.myapplication.data.MedicineDbHelper;

import java.text.DecimalFormat;
import java.text.NumberFormat;

import static com.example.endle.myapplication.data.MedicineContract.MedicineEntry;
...
public class DetailActivity extends AppCompatActivity {
    ...
    private void addValuesToCart() {
        ...
        cartValues.put(MedicineContract.MedicineEntry.COLUMN_CART_NAME, fragranceName);
        cartValues.put(MedicineContract.MedicineEntry.COLUMN_CART_IMAGE, fragImage);
        cartValues.put(MedicineContract.MedicineEntry.COLUMN_CART_QUANTITY, mQuantity);
        cartValues.put(MedicineContract.MedicineEntry.COLUMN_CART_TOTAL_PRICE, mTotalPrice);



        mContentResolver.insert(MedicineContract.MedicineEntry.CONTENT_URI, cartValues);
