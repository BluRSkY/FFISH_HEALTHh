...
public class MedicineProvider extends ContentProvider {
    ...
    static {
        ...
        sUriMatcher.addURI(MedicineContract.CONTENT_AUTHORITY, MedicineContract.PATH_FRAGRANCE, Medicine);

        sUriMatcher.addURI(MedicineContract.CONTENT_AUTHORITY, MedicineContract.PATH_CART, CART);
        ...
        sUriMatcher.addURI(MedicineContract.CONTENT_AUTHORITY, MedicineContract.PATH_FRAGRANCE + "/#", FRAGRANCE_ID);
        sUriMatcher.addURI(MedicineContract.CONTENT_AUTHORITY, MedicineContract.PATH_CART + "/#", CART_ID);
    ...
    public boolean onCreate() {
        medicineDbHelper = new MedicineDbHelper(getContext());
        return true;
    }
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        SQLiteDatabase database = medicineDbHelper.getReadableDatabase();
        ...
        switch (match) {
            case Medicine:
                ...
                break;
            case CART:
                cursor = database.query(MedicineContract.MedicineEntry.CART_TABLE, projection, selection, selectionArgs,
                        null, null, sortOrder);
                break;
            case CART_ID:
                selection = MedicineContract.MedicineEntry._CARTID + "=?";
    ...
    private Uri insertCart(Uri uri, ContentValues values) {
        ...
        SQLiteDatabase database = medicineDbHelper.getWritableDatabase();

        // Insert the new cart with the given values
        long id = database.insert(MedicineContract.MedicineEntry.CART_TABLE, null, values);
    ...
    public int delete(@NonNull Uri uri, @Nullable String s, @Nullable String[] strings) {
        ...
        final SQLiteDatabase db = medicineDbHelper.getWritableDatabase();
        ...
        switch (match) {
            ...
            case CART_ID:
                ...
                cartDeleted = db.delete(MedicineContract.MedicineEntry.CART_TABLE, "_id=?", new String[]{id});
                break;
            default:
